    ...
    public void configure(final HttpSecurity http) throws Exception {
        http
              ...
              //  .antMatchers("/admin/category/{parent_id}").hasAnyRole("SELLER")
                ...
                .antMatchers("/seller/showData/{id}").hasAnyRole("SELLER")
                .antMatchers("/updateSellerProfile/{id}").hasAnyRole("SELLER")
                .antMatchers("/updateSellerAddress/{id}").hasAnyRole("SELLER")
