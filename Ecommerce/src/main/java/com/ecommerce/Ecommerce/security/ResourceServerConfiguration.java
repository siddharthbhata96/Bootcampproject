...
public class ResourceServerConfiguration extends ResourceServerConfigurerAdapter {
    ...
    public void configure(final HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/custSave").permitAll()
                .antMatchers("/sellSave").permitAll()
                ...
                .antMatchers("/productVariationDisplay/{Id}").hasAnyRole("CUSTOMER","SELLER","ADMIN")
                ...
                .antMatchers("/account-unlock/{userEmail}").hasAnyRole("ADMIN")
                .antMatchers("/metadata-fields/*").hasAnyRole("ADMIN")
                .antMatchers("/sellerProduct/viewAll").hasAnyRole("SELLER")
                .antMatchers("/sellerProduct/{product_id}").hasAnyRole("SELLER")
                ...
                .antMatchers("/products/{category_name}").hasAnyRole("SELLER","CUSTOMER","ADMIN")
